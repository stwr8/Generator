...
const Header = () => {
    ...
    return (
        <>
            <header
                className={`bg-white fixed z-10 w-full top-0 drop-shadow-md`}
            >
                {/* --- Header top --- */}
                <div
                    className={`${
                        scrollDown ? "hidden" : "flex"
                    } container items-center justify-end !py-[11px] border-b-[1px] top-0 sticky `}
                >
                ...
                {/* --- Header bottom --- */}
                <div
                    className={`container bg-white z-50 w-full flex items-center justify-between !py-[18px]`}
                >
