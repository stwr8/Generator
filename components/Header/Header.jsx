...
const Header = () => {
  ...
  useEffect(() => {
    ...
    return window.addEventListener("scroll", toggleHeader);
  }, []);

  const toggleHeader = () => setScrollDown(window.pageYOffset > 0);
  ...
  return (
    <>
      <header className={`bg-white fixed z-10 w-full top-0 drop-shadow-md`}>
        {/* --- Header top --- */}
        <div
          className={`${
            scrollDown ? "hidden" : "flex"
          } items-center justify-end py-[11px] border-b-[1px] top-0 sticky`}
        >
          <ul className="flex items-center space-x-5">
            ...
            <li className="flex items-center">
              <Image src={Call} width={20} height={20} alt="Picture of call" />
              <Link
          ...
          >
            {uzb
              ...
              : null}
            <Image
              className={`duration-200 ml-2 ${drop ? "-rotate-180" : ""}`}
              src={Vector}
              width={10}
              height={6}
              alt="Picture of the author"
        ...
        >
          ...
          <div className="hidden md:flex items-center">
            ...
            >
              <Image src={CallWhite} width={20} height={20} alt="call-image" />
        ...
        >
          ...
          <ul className="flex items-center flex-col text-center space-y-5 mt-5">
            ...
            <li className="font-medium text-base text-[#333]  uppercase">
              <Link href={`tel:+998980013666`} className="flex items-center">
                <Image src={Call} width={20} height={20} alt="call-image" />
